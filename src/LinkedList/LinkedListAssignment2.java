...
//Hint:
//Identify how many pointers you require and try traversing them to right places and connect nodes
// accordingly also don't forget to disconnect what's required else it could create cycles.
//Input format :
